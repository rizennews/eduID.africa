...
export function AboutOverviewSection({ locale: _locale, dict }: AboutOverviewSectionProps) {
  return (
    <section className="pt-10 sm:pt-12 pb-6 sm:pb-8 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Unified Executive Card: Framework Architecture Overview */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-extrabold font-heading text-[#0A162B] tracking-tight leading-[1.15]">
                ...
                <span className="text-[#1A73C3] block mt-1.5">{dict.about.headline2}</span>
              </h2>
            </div>

            {/* Right Column: Refined Editorial Narrative with Elegant Divider */}
